...
LAYOUT(
    ...
    K_LEFT_CTRL, K_LEFT_ALT, K_LEFT_SUPER, KT_FN, K_SPACE, K_RIGHT_ALT, K_RIGHT_SUPER, K_RIGHT_CTRL, K_LEFT, K_DOWN, K_RIGHT, K_NUM_0, K_NUM_PERIOD
),
LAYOUT(
    ...
    K_CAPS, K_A, K_S, K_D, K_F, K_G, K_H, K_J, K_K, K_L, K_SEMICOLON, K_QUOTE, K_ENTER, K_NUM_4, K_NUM_5, K_NUM_6,
    K_LEFT_SHIFT, K_Z, K_X, K_C, K_V, K_B, K_N, K_M, K_COMMA, K_PERIOD, K_SLASH, K_RIGHT_SHIFT, K_PGUP, K_NUM_1, K_NUM_2, K_NUM_3, K_NUM_ENTER,
    K_LEFT_CTRL, K_LEFT_ALT, K_LEFT_SUPER, KT_FN, K_SPACE, K_RIGHT_ALT, K_RIGHT_SUPER, K_RIGHT_CTRL, K_HOME, K_PGDN, K_END, K_NUM_0, K_NUM_PERIOD
)
};
