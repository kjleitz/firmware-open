...
LAYOUT(
    ...
    K_LEFT_CTRL, K_LEFT_ALT, K_LEFT_SUPER, K_SPACE, K_RIGHT_ALT, K_RIGHT_SUPER, K_RIGHT_CTRL, K_LEFT, K_DOWN, K_RIGHT, K_NUM_0, K_NUM_PERIOD
),
LAYOUT(
    ...
    K_LEFT_CTRL, K_LEFT_ALT, K_LEFT_SUPER, K_SPACE, K_RIGHT_ALT, K_RIGHT_SUPER, K_RIGHT_CTRL, K_HOME, K_PGDN, K_END, K_NUM_0, K_NUM_PERIOD
)
};
